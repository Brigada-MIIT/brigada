...
function api_email_resend($args) {
    ...
    switch($verification) {
        case 1:
            ...
            break;
        case 2:
            echo "Прежде чем, попробовать снова, подождите 5 минут. Если после нескольких попыток переотправки письмо не приходит, обратитесь к <a href='".$link."'>администратору</a>.";
            break;
        default:
