              ...
              success: async function(data) {
                ...
                if (res.result == 0) {
                    ...
                    Swal.fire({
                        ...
                        footer: '<a target="_blank" onclick="resendEmail(res.text)" hreff="/email/resend/' + res.text + '">Переотправить письмо</a>&nbsp;|&nbsp;<a href="<?php echo $link_to_admin ?>">Возникли вопросы?</a>'
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
